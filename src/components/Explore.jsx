...
const Explore = () => {
  ...
  From real-time web apps to machine learning models, I experiment with ideas that solve practical problems and improve how systems behave in real-world conditions.
</p>
          </div>
        </div>
      </div>
